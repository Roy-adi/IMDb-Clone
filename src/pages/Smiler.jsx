...
const Smiler = () => {
    ...
    const SMILER_API = `https://api.themoviedb.org/3/movie/${id}/similar?api_key=${API_KEY}&language=en-US`;
            ...
            >
                {movies.map((movie) => (
                    ...
                    src={movie.backdrop_path
                        ...
                        : 'https://img.freepik.com/free-psd/girl-character-with-404-error_23-2149838727.jpg?size=626&ext=jpg&ga=GA1.1.1457208155.1693933855&semt=ais'}
